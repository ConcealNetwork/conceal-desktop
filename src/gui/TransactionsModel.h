...
public:
  enum Columns {
    COLUMN_STATE = 0, COLUMN_DATE, COLUMN_AMOUNT, COLUMN_ADDRESS, COLUMN_MESSAGE, COLUMN_PAYMENT_ID, COLUMN_HASH, COLUMN_SECRETKEY, COLUMN_FEE,
    COLUMN_HEIGHT, COLUMN_TYPE
  };

  enum Roles {
    ROLE_DATE = Qt::UserRole, ROLE_TYPE, ROLE_HASH, ROLE_SECRETKEY, ROLE_ADDRESS, ROLE_AMOUNT, ROLE_PAYMENT_ID, ROLE_ICON,
