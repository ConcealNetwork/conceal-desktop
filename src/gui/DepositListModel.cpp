...
bool DepositListModel::filterAcceptsColumn(int _sourceColumn, const QModelIndex& _sourceParent) const {
  ...
  return _sourceColumn == DepositModel::COLUMN_CREATING_TIME || _sourceColumn == DepositModel::COLUMN_TYPE || _sourceColumn == DepositModel::COLUMN_STATE || _sourceColumn == DepositModel::COLUMN_UNLOCK_TIME || _sourceColumn == DepositModel::COLUMN_UNLOCK_HEIGHT || _sourceColumn == DepositModel::COLUMN_AMOUNT || _sourceColumn == DepositModel::COLUMN_TERM_RATE || _sourceColumn == DepositModel::COLUMN_INTEREST;
}
