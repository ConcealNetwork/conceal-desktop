...
MessagesModel::MessagesModel() : QAbstractItemModel() {
  ...
  connect(&WalletAdapter::instance(), &WalletAdapter::walletTransactionCreatedSignal, this, static_cast<void(MessagesModel::*)(cn::TransactionId)>(&MessagesModel::appendTransaction), Qt::QueuedConnection);
